...
1. Upload the plugin files to the `/wp-content/plugins/wp-aiCaptcha` directory, or install the plugin through the WordPress plugin screen directly.
2. Activate the plugin through the 'Plugins' screen in WordPress.
3. Go to **Settings > AI Captcha** and enter your API key from [aicaptcha.site](https://aicaptcha.site).
...
2. Example of protected form (no visual CAPTCHA shown).
3. Integration with WooCommerce login/register.
...
= 1.0.0 =
First release. Adds AI CAPTCHA support across essential WordPress forms.
